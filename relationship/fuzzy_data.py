...
df = read_csv('data/sampling_617685_metric_10min_datetime_origin.csv', header=None, index_col=False, names=colnames, engine='python')
...
dataFuzzyDf.to_csv('data/2_Fuzzy_Mem_sampling_617685_metric_10min_datetime_origin.csv', index=False, header=None)